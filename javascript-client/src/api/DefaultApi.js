...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * 
     * @param {String} nCdServico | Código | Serviço               | |--------|-----------------------| | 40010  | SEDEX Varejo          | | 40045  | SEDEX a Cobrar Varejo | | 40215  | SEDEX 10 Varejo       | | 40290  | SEDEX Hoje Varejo     | | 41106  | PAC Varejo            |  ##### Obs:    Pode ser mais de um numa consulta separados por vírgula. 
     ...
     * @param {Date} sDtCalculo Data tipo dd/mm/aaaa. Ex:    21/10/2017 
     * @param {Object} opts Optional parameters
     * @param {String} opts.nCdServico | Código | Serviço               | |--------|-----------------------| | 40010  | SEDEX Varejo          | | 40045  | SEDEX a Cobrar Varejo | | 40215  | SEDEX 10 Varejo       | | 40290  | SEDEX Hoje Varejo     | | 41106  | PAC Varejo            | ##### Obs:    Pode ser mais de um numa consulta separados por vírgula. 
     ...
     */
    this.calcPrecoDataPost = function(nCdEmpresa, sDsSenha, sCepOrigem, sCepDestino, nCdFormato, nVlComprimento, nVlAltura, nVlLargura, nVlDiametro, sCdMaoPropria, nVlValorDeclarado, sCdAvisoRecebimento, sDtCalculo, opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.calcPrecoPrazoDataPost = function(nCdEmpresa, sDsSenha, sCepOrigem, sCepDestino, nCdFormato, nVlComprimento, nVlAltura, nVlLargura, nVlDiametro, sCdMaoPropria, nVlValorDeclarado, sCdAvisoRecebimento, sDtCalculo, opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.calcPrecoPrazoRestricaoPost = function(nCdEmpresa, sDsSenha, sCepOrigem, sCepDestino, nCdFormato, nVlComprimento, nVlAltura, nVlLargura, nVlDiametro, sCdMaoPropria, nVlValorDeclarado, sCdAvisoRecebimento, sDtCalculo, opts, callback) {
      opts = opts || {};
      var postBody = null;
